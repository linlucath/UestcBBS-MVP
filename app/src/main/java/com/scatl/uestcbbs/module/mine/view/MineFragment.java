...
public class MineFragment extends BaseFragment implements MineView {
    ...
    private Switch nightModeSwitch, noAnonymousSwitch; 
    ...
    public static boolean is_get_anonymous = false; // 默认为true或你需要的初始值
    ...
    protected void findView() {
        ...
        noAnonymousSwitch = view.findViewById(R.id.mine_no_anonymous_switch); // 2. 获取控件
    ...
    protected void initView() {
        ...
        noAnonymousSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                is_get_anonymous = isChecked; // 状态与开关相反
            }
        });
    }
